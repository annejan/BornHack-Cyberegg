...
impl Note {
    // Octave 2
    pub const C2: Self = Self::Midi(36);
    pub const Cs2: Self = Self::Midi(37);
    pub const D2: Self = Self::Midi(38);
    pub const Ds2: Self = Self::Midi(39);
    pub const E2: Self = Self::Midi(40);
    pub const F2: Self = Self::Midi(41);
    pub const Fs2: Self = Self::Midi(42);
    pub const G2: Self = Self::Midi(43);
    pub const Gs2: Self = Self::Midi(44);
    pub const A2: Self = Self::Midi(45);
    pub const As2: Self = Self::Midi(46);
    pub const B2: Self = Self::Midi(47);
    // Octave 3
    pub const C3: Self = Self::Midi(48);
    pub const Cs3: Self = Self::Midi(49);
    pub const D3: Self = Self::Midi(50);
    pub const Ds3: Self = Self::Midi(51);
    pub const E3: Self = Self::Midi(52);
    pub const F3: Self = Self::Midi(53);
    pub const Fs3: Self = Self::Midi(54);
    pub const G3: Self = Self::Midi(55);
    pub const Gs3: Self = Self::Midi(56);
    pub const A3: Self = Self::Midi(57);
    pub const As3: Self = Self::Midi(58);
    pub const B3: Self = Self::Midi(59);
    // Octave 4
    pub const C4: Self = Self::Midi(60);
    pub const Cs4: Self = Self::Midi(61);
    pub const D4: Self = Self::Midi(62);
    pub const Ds4: Self = Self::Midi(63);
    pub const E4: Self = Self::Midi(64);
    pub const F4: Self = Self::Midi(65);
    pub const Fs4: Self = Self::Midi(66);
    pub const G4: Self = Self::Midi(67);
    pub const Gs4: Self = Self::Midi(68);
    pub const A4: Self = Self::Midi(69);
    pub const As4: Self = Self::Midi(70);
    pub const B4: Self = Self::Midi(71);
    // Octave 5
    pub const C5: Self = Self::Midi(72);
    pub const Cs5: Self = Self::Midi(73);
    pub const D5: Self = Self::Midi(74);
    pub const Ds5: Self = Self::Midi(75);
    pub const E5: Self = Self::Midi(76);
    pub const F5: Self = Self::Midi(77);
    pub const Fs5: Self = Self::Midi(78);
    pub const G5: Self = Self::Midi(79);
    pub const Gs5: Self = Self::Midi(80);
    pub const A5: Self = Self::Midi(81);
    pub const As5: Self = Self::Midi(82);
    pub const B5: Self = Self::Midi(83);
    // Octave 6
    pub const C6: Self = Self::Midi(84);
    pub const Cs6: Self = Self::Midi(85);
    pub const D6: Self = Self::Midi(86);
    pub const Ds6: Self = Self::Midi(87);
    pub const E6: Self = Self::Midi(88);
    pub const F6: Self = Self::Midi(89);
    pub const Fs6: Self = Self::Midi(90);
    pub const G6: Self = Self::Midi(91);
    pub const Gs6: Self = Self::Midi(92);
    pub const A6: Self = Self::Midi(93);
    pub const As6: Self = Self::Midi(94);
    pub const B6: Self = Self::Midi(95);
